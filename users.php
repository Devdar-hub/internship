...
html, body {
  ...
  <div id="main" style="margin-top:0px;">
        ...
        <span style="font-size:30px;cursor:pointer; margin-top:60%;" onclick="openNav()" >&#9776; Users</span>
