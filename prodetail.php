...
<section class="mb-5" style="margin-top:20px; ">
    ...
    <div class="row ">
      ...
      <div class="col-md-8 box">
        ...
        <a href="payment\index.html" target="_blank"><button type="button" class="btn btn-md mr-1 mb-2 addMore" title="This button is for the Vendor. He would
be asked to create a link for payment,
which he is supposed to send to the 
respective buyer." style="background-color:black; color:white;border-radius:0px; background-color:rgba(143, 4, 34, 0.973);">Payment link</button></a>
      </div>
    </div>
    <div id="WAButton"></div>
    ...
    if (doc.exists) {
        ...
        $(function () {
          $('#WAButton').floatingWhatsApp({
                  ...
                  message: 'Hey there! This is a message from the customer at our site Bibliosmia, inquiring about an advertisement posted by you. Book Title: '+data.title,
                  buttonImage: '<img src="whatsapp.png" />', //Button Image
