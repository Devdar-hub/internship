...
<body>
  ...
  <div id="mySidenav" class="sidenav" style="margin-top:7%;">
  ...
  <script>
    ...
    function users() {
      ...
      db.collection("Users").get().then((querySnapshot)=>{
        ...
        document.getElementById("table").innerHTML += '<tr><th scope="row">1</th><td>'+data[1].username+'</td><td>'+id[1]+'</td><td>'+data[1].email+'</td><td><button type="button" onclick="removeuser(event)" class="btn" style="color: white; background-color: lightgrey; border-style:solid; border-color: lightgrey; border-radius:0px; "><span class="glyphicon glyphicon-remove"></span> Remove</button></td></tr>'
